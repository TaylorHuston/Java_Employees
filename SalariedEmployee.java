...
public class SalariedEmployee extends Employee {
    ...
    //Constructor
    public SalariedEmployee(String nFirstName, String nLastName, 
            String nssNumber, double nWeeklySalary) {
    ...
    public static void main(String[] args) {
       SalariedEmployee emp = new SalariedEmployee("Jack", "Dangerfield", 
               "333-33-333", 3000);
